...
const NotificationCard = ({ notification, onDelete }: NotificationCardProps) => {
    ...
    const getNotificationIcon = () => {
        switch (notification.type) {
            case "like":
                return <Feather name='heart' size={200} color='#E0245E' />
            case "comment":
                return <Feather name='message-circle' size={200} color='#1DA1F2' />
            case "follow":
                return <Feather name='user-plus' size={200} color='#17BF63' />
            default:
                return <Feather name='bell' size={200} color='#657786' />
        }
    }
