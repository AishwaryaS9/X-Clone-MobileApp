        ...
        <SafeAreaView className='flex-1 bg-white' edges={["top"]}>
            ...
            <ScrollView className='flex-1' showsVerticalScrollIndicator={false}
                ...
                {conversationsList.map((conversation) => (
                    ...
                    active:bg-gray-50' onPress={() => openConversation(conversation)}
                    ...
                    <SafeAreaView className="flex-1">
                        ...
                        <View className='flex-row items-center px-4 py-3 border-t border-gray-100'>
                            <View className='flex-1 flex-row items-center bg-gray-100 rounded-full px-4 py-3 mr-3'>
                                <TextInput className='flex-1 text-base' placeholder='Start a message...'
                                    placeholderTextColor="#657786" value={newMessage}
                                    onChangeText={setNewMessage} multiline />
                            </View>
